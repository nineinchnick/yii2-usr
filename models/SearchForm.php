...
class SearchForm extends \yii\base\Model
{
    ...
    public function getIdentity($id = null)
    {
        if ($this->_identity === null) {
            ...
            if ($this->_identity !== null && !($this->_identity instanceof ManagedIdentityInterface)) {
                throw new Exception(Yii::t('usr', 'The {class} class must implement the {interface} interface.', ['{class}' => get_class($this->_identity), '{interface}' => 'IManagedIdentity']));
            }
        }
